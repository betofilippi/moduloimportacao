...
export const numerarioFieldAccessors = {
  // Main fields - OCR field first, database field second
  numero_fatura: createFlexibleAccessor('invoice_number', 'invoiceNumber'),
  tipo_documento: createFlexibleAccessor('tipo_documento', 'tipo_documento'),
  data_documento: createFlexibleAccessor('data_documento', 'data_documento'),
  ...
  valor_reais: createFlexibleAccessor('valor_reais', 'valor_reais'),
  banco: createFlexibleAccessor('banco', 'banco'),
  conta_destino: createFlexibleAccessor('conta_destino', 'conta_destino'),
  forma_pagamento: createFlexibleAccessor('forma_pagamento', 'forma_pagamento'),
  parcelas: createFlexibleAccessor('parcelas', 'parcelas'),
  impostos: createFlexibleAccessor('impostos', 'impostos'),
  taxas: createFlexibleAccessor('taxas', 'taxas'),
  desconto: createFlexibleAccessor('desconto', 'desconto'),
  valor_liquido: createFlexibleAccessor('valor_liquido', 'valor_liquido'),
  vendedor: createFlexibleAccessor('vendedor', 'vendedor'),
  comissao: createFlexibleAccessor('comissao', 'comissao'),
  referencia_pedido: createFlexibleAccessor('referencia_pedido', 'referencia_pedido'),
  observacoes: createFlexibleAccessor('observacoes', 'observacoes'),
  categoria: createFlexibleAccessor('categoria', 'categoria'),
  nf_emitida: createFlexibleAccessor('nf_emitida', 'nf_emitida'),
  numero_nf: createFlexibleAccessor('numero_nf', 'numero_nf'),
  data_emissao_nf: createFlexibleAccessor('data_emissao_nf', 'data_emissao_nf'),
  chave_nf: createFlexibleAccessor('chave_nf', 'chave_nf'),
